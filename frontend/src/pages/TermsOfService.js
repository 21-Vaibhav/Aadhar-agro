          ...
          <Card sx={{ p: { xs: 3, md: 6 }, boxShadow: 1, borderRadius: 2 }}>
            <CardContent>
              ...
              <Typography paragraph sx={{ lineHeight: 1.8 }}>
                This website is operated by J S INDUSTRIES. Throughout the site,
                the terms "we", "us" and "our" refer to J S INDUSTRIES. J S
                INDUSTRIES offers this website, including all information, tools
              ...
              <Typography paragraph sx={{ lineHeight: 1.8 }}>
                In no case shall J S INDUSTRIES, our directors, officers,
              ...
              <Typography paragraph sx={{ lineHeight: 1.8 }}>
                You agree to indemnify, defend and hold harmless J S INDUSTRIES
              ...
              <Typography paragraph sx={{ lineHeight: 1.8 }}>
                ...
                accordance with the laws of India and jurisdiction of Hubli,
                Karnataka.
              </Typography>
              <Divider sx={{ my: 4 }} />
              <Typography
